...
const Testimonials = () => {
  return (
    ...
    <AnimatedGradientText className='bg-background backdrop-blur-0'>
          ...
          Discover why thousands are choosing INDIAN GEN AI PLATFORM for effortless, high-quality photo generation, from LinkedIn headshots to vibrant social media content.
          </p>
